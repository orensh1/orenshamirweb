            ...
            <Magnetic>
              <div className="group relative">
                ...
                <Button
                  ...
                  className="relative !text-base md:!text-2xl !px-8 md:!px-12 !py-3 md:!py-5 w-auto max-w-xs md:max-w-none rounded-full bg-white text-black !font-['Rubik'] !font-extrabold !tracking-tighter border-2 border-white/20 overflow-hidden shadow-lg"
                >
                  {/* Shimmer Effect */}
